...
async function main() {
  ...
  for (let height = since; height < until; height++) {
    ...
    const pooldata = await apiAt.query.cyruxBasePool.pools.entries();
    ...
    const oldpooldata = await apiAt.query.cyruxStakePool.stakePools.entries();
    ...
    const workerbinding = await apiAt.query.cyruxComputation.workerBindings.entries();
    ...
    const stakes = await apiAt.query.cyruxComputation.stakes.entries();
