...
async function main() {
    ...
    const stakerData = await api0.query.cyruxStakePool.poolStakers.entries();
    const poolData = await api0.query.cyruxStakePool.stakePools.entries();
    ...
    const newPoolData = await api1.query.cyruxBasePool.pools.entries();
