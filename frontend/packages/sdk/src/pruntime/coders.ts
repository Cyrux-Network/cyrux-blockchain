...
export function InkQueryMessage(
  ...
  return cyruxTypes.createType('InkQuery', {
    head: {
...
export function PlainInkCommand(
  ...
  return cyruxTypes.createType('CommandPayload', {
    Plain: cyruxTypes.createType('InkCommand', {
      InkMessage: {
        nonce,
        message: cyruxTypes.createType('Vec<u8>', encParams).toHex(),
        transfer: value,
...
export function EncryptedInkCommand(
  ...
  const payload = cyruxTypes.createType('InkCommand', {
    InkMessage: {
      nonce,
      message: cyruxTypes.createType('Vec<u8>', encParams).toHex(),
      transfer: value,
