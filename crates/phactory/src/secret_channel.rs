...
mod sender {
    ...
    use cyrux_mq::traits::{MessageChannel, MessagePrepareChannel};
    use cyrux_mq::Path;
    ...
    impl<'a, MsgChan: MessageChannel> cyrux_mq::traits::MessageChannel
    ...
    impl<'a, MsgChan: MessagePrepareChannel> cyrux_mq::traits::MessagePrepareChannel
        for BoundSecretMessageChannel<'a, MsgChan>
    {
        type Signer = MsgChan::Signer;
        ...
        fn prepare_with_data(
            ...
            data: Vec<u8>,
            to: impl Into<Path>,
        ) -> cyrux_mq::SigningMessage<Self::Signer> {
            let payload = self.encrypt_payload(data);
...
mod receiver {
    ...
    use cyrux_mq::{MessageOrigin, ReceiveError, TypedReceiver};
