...
pub use cyrux_mq::{ContractClusterId, ContractId};
...
pub mod messaging {
    ...
    use cyrux_mq::bind_topic;
    use sp_core::crypto::AccountId32;

    bind_topic!(ClusterEvent, b"cyrux/cluster/event");
    ...
    bind_topic!(ContractOperation<CodeHash, AccountId>, b"cyrux/contract/op");
    #[derive(Encode, Decode, Clone, PartialEq, Eq, Debug, ::scale_info::TypeInfo)]
    ...
    bind_topic!(WorkerClusterReport, b"cyrux/cluster/worker/report");
    #[derive(Encode, Decode, Clone, PartialEq, Eq, Debug, TypeInfo)]
    ...
    bind_topic!(ClusterOperation<AccountId>, b"cyrux/cluster/key");
    #[derive(Encode, Decode, Clone, PartialEq, Eq, Debug, TypeInfo)]
...
pub fn command_topic(id: ContractId) -> Vec<u8> {
    format!("cyrux/contract/{}/command", hex::encode(id))
        .as_bytes()
        .to_vec()
}
...
mod tests {
    ...
    fn helper_fn_works() {
        ...
        assert_eq!(cmd_topic, b"cyrux/contract/0101010101010101010101010101010101010101010101010101010101010101/command".to_vec());
