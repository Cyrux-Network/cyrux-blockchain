...
pub mod messaging {
    ...
    pub use cyrux_mq::bind_topic;
    pub use cyrux_mq::types::*;
    ...
    bind_topic!(SystemEvent, b"cyrux/system/event");
    #[derive(Encode, Decode, Clone, PartialEq, Eq, Debug, TypeInfo)]
    ...
    bind_topic!(WorkingReportEvent, b"cyrux/mining/report");
    #[derive(Encode, Decode, Clone, PartialEq, Eq, Debug, TypeInfo)]
    ...
    bind_topic!(WorkingInfoUpdateEvent<BlockNumber>, b"^cyrux/mining/update");
    ...
    bind_topic!(GatekeeperLaunch, b"cyrux/gatekeeper/launch");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
    ...
    bind_topic!(GatekeeperChange, b"cyrux/gatekeeper/change");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
    ...
    bind_topic!(KeyDistribution<BlockNumber>, b"cyrux/gatekeeper/key");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
    ...
    // Messages: Gatekeeper
    bind_topic!(GatekeeperEvent, b"cyrux/gatekeeper/event");
    #[derive(Encode, Decode, Clone, Debug, PartialEq, Eq, TypeInfo)]
    pub enum GatekeeperEvent {
        NewRandomNumber(RandomNumberEvent),
        TokenomicParametersChanged(TokenomicParameters),
        /// Deprecated after <https://github.com/Cyrux-Network/cyrux-blockchain/pull/499>
        /// Dropped in cyrux. The index is reserved here for Khala+pruntime-v0 compatibility.
        _RepairV,
        /// Trigger a set of changes:
        /// - <https://github.com/Cyrux-Network/cyrux-blockchain/issues/693>
        /// - <https://github.com/Cyrux-Network/cyrux-blockchain/issues/676>
        /// Dropped in cyrux. The index is reserved here for Khala+pruntime-v0 compatibility.
        _cyruxLaunched,
