...
fn export_git_revision() {
    ...
    println!("cargo:rustc-env=cyrux_GIT_REVISION={revision}{tail}");
    println!("cargo:rustc-env=cyrux_GIT_COMMIT_TS={timestamp}");
    println!("cargo:rustc-env=cyrux_GIT_REVISION_WITH_TS={revision}-{timestamp}{tail}");
