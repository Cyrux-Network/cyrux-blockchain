...
const PINK_EVENT_TOPIC: &[u8] = b"cyrux.pink.event";
...
///  - `OnBlockEnd`: The receiver contract will be invoked once all events in a cyrux chain block have been processed.
///
/// # Arguments
///
