...
use cyrux_crypto::sr25519::Sr25519SecretKey;
use pink_capi::{
...
impl ecall::ECalls for ECallImpl {
    ...
    fn upload_code(
        ...
        */
        let info =
            cyrux_wasm_checker::wasm_info(&code).map_err(|err| format!("Invalid wasm: {err:?}"))?;
    ...
    fn git_revision(&self) -> String {
        cyrux_git_revision::git_revision().to_string()
    }
