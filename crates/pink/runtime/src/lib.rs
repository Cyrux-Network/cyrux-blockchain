//! # Glossary
//!
//! - **pruntime**: A program within the TEE that monitors blocks from the cyrux blockchain and processes onchain
...
//!
//! This crate contains the core functionality of the Pink runtime, which powers the ink contract at cyrux.
...
//! when it starts, based on instructions from the cyrux blockchain. When transactions or queries are sent to
...
//! These extensions introduce cyrux-exclusive features, such as enabling HTTP requests in query operations.
//!
