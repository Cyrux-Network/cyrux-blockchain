...
//! cyrux Pallets
//!
//! This is the central crate of cyrux tightly-coupled pallets.
...
pub trait cyruxConfig: frame_system::Config {
	type Currency: LockableCurrency<Self::AccountId, Moment = BlockNumberFor<Self>>;
}
/// The unified type Balance of pallets from the runtime T.
type BalanceOf<T> = <<T as cyruxConfig>::Currency as frame_support::traits::Currency<
	<T as frame_system::Config>::AccountId,
>>::Balance;
/// The unified type ImBalance of pallets from the runtime T.
type NegativeImbalanceOf<T> = <<T as cyruxConfig>::Currency as frame_support::traits::Currency<
	<T as frame_system::Config>::AccountId,
>>::NegativeImbalance;
