...
use cyrux_clap_parsers::parse_duration;
use cyrux_git_revision::git_revision_with_ts;

mod handover;
use cyrux_sanitized_logger as logger;
...
#[clap(about = "The cyrux TEE worker app.", version, author)]
struct Args {
