...
impl TxManager {
    pub async fn register_worker(
        ...
        let tx_payload = if v2 {
            EncodedPayload::new("cyruxRegistry", "register_worker_v2", encoded)
        } else {
            EncodedPayload::new("cyruxRegistry", "register_worker", encoded)
        };
    ...
    pub async fn sync_offchain_message(
        ...
        let tx_payload = EncodedPayload::new("cyruxMq", "sync_offchain_message", encoded);
