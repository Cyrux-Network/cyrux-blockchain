...
#[command(name="prb", version, about="cyrux Runtime Bridge Worker Manager", long_about = None)]
pub struct WorkerManagerCliArgs {
    ...
    #[arg(long, env, default_value = "https://pccs.cyrux.network/sgx/certification/v4/")]
    pub pccs_url: String,
