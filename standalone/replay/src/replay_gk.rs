...
use cyrux_mq::{MessageDispatcher, Path as MqPath, Sr25519Signer, Topic};
use cyrux_types::WorkerPublicKey;
...
impl ReplayFactory {
    ...
    fn load(reader: impl Read) -> Self {
        ...
        let mut factory: Self =
            cyrux_mq::checkpoint_helper::using_dispatcher(&mut dispatcher, move || {
...
impl cyrux_mq::traits::MessageChannel for ReplayMsgChannel {
