...
use node_runtime::{
    ...
    NominationPoolsConfig, cyruxRegistryConfig, SessionConfig, SessionKeys, SocietyConfig,
...
/// Extension for the cyrux devnet genesis config to support a custom changes to the genesis state.
...
pub fn testnet_config() -> Result<ChainSpec, String> {
    ChainSpec::from_json_bytes(&include_bytes!("../res/cyrux_testnet.json")[..])
}
...
fn testnet_local_config_genesis() -> RuntimeGenesisConfig {
    ...
    // generated with secret: subkey inspect -n cyrux --scheme Sr25519 "$secret"//phat6
...
pub fn testnet_genesis(
    ...
    let cyrux_registry = match dev {
        true => cyruxRegistryConfig {
            workers: vec![(
                dev_sr25519_pubkey,
                dev_ecdh_pubkey,
	...
	RuntimeGenesisConfig {
        ...
        cyrux_registry,
        cyrux_computation: Default::default(),
