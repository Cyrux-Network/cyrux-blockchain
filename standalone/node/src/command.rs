...
impl SubstrateCli for Cli {
    ...
    fn support_url() -> String {
        "https://github.com/Cyrux-Network/cyrux-blockchain/issues/new".into()
    }
    ...
    fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
        let spec = match id {
            ...
            "cyrux" | "cyrux_testnet" => Box::new(chain_spec::testnet_config()?),
            "cyrux-local" | "cyrux_testnet-local" => Box::new(chain_spec::testnet_local_config()),
