...
pub fn create_extrinsic(
    ...
    let extra: node_runtime::SignedExtra = (
        ...
        cyrux_pallets::pallet_mq::CheckMqSequence::<node_runtime::Runtime>::new(),
    ...
    fn test_sync() {
        ...
        sc_service_test::sync(
            ...
            |service, _| {
                ...
                let check_mq_sequence = cyrux_pallets::mq::CheckMqSequence::new();
